...
| **📊 Stack Overflow Survey Deep Dive** | Performed exploratory analysis on developer trends, most-used tools, and employment insights using the latest Stack Overflow data. | Pandas, NumPy, Matplotlib, Seaborn, Jupyter Notebook | [📂 Repo](https://github.com/shrush2107/Exploring-StackOverFlow-Data) |
| **🩺 Predictive Analysis and Modeling for Diabetes Detection** | Built a supervised ML pipeline on public health survey data with preprocessing, oversampling (SMOTE), and hyperparameter tuning for model optimization. | Python, Scikit-learn, Data Cleaning and Wrangling, Feature Engineering, PCA, Hyperparameter Tunning, Oversampling(SMOTE, ADASYN) | [📂 Repo](https://github.com/shrush2107/Predictive-Analysis-and-Modeling-for-Diabetes-Detection) |
| **👥 On-demand Delivery Platform Customer Segmentation** | Performed analysis to segment users into behavioral clusters, and applied classification to predict high-value segments. | Clustering (K-Means), Elbow Method, PCA, Supervised Machine learning, Pandas, Seaborn | [📂 Repo](https://github.com/shrush2107/Customer_Segmentation) |
